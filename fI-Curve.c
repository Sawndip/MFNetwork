...
#define RHO_INIT 0.502946 /*0.165171*/ //0.502946 //0.502964 /*0.185*/ /*0.176923 1hz net*/ //165 //0.35 //0.38 //0.5 //1.
//#define w_ee (RHO_INIT * 0.2e-3)
#define w_min 0.0
...
//#define J_EXT /*(0.00695)*/ /*(0.0113628)*/ /*(0.00695)*/ /*(0.00686) in-vivo*/ /*(0.0072) 1hz network*/ /*(0.0066)*/
#define NU_E_INIT (9.998571) /*(1.25)*/
#define NU_I_INIT (9.958089) /*(1.25)*/
...
int main(void) {
	...
	for(float mu_tot = 0; mu_tot < 31e-3; mu_tot += 0.5e-3){
	...
	for (float mu_ext = 0.1e-3; mu_ext <= 12e-3; mu_ext += 0.5e-3)
	{
		float mu_tot_e, mu_tot_i;
		float x_local, y_local;
		float e_trans, i_trans;
